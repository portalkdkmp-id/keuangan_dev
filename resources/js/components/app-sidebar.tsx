...
export function AppSidebar() {
    ...
    const mainNavItems: NavItem[] = [
        ...
        can('cooperatives.view') && { title: 'Koperasi', href: '/cooperatives', icon: Warehouse },
        ...
        can('approval-submissions.view-director-revision') && { title: 'Revisi Director', href: '/approval/director-revisions', icon: ClipboardList },
        can('director-submissions.view') && { title: 'Pengajuan Masuk Direktur', href: '/director/submissions', icon: ShieldCheck },
        can('director-monitoring.view') && { title: 'Dashboard Director', href: '/director/monitoring', icon: Monitor },
        can('director-disbursements.view') && { title: 'Pencairan Dana', href: '/director/disbursements', icon: CreditCard },
        ...
        (can('submission-masters.view') || can('submission-categories.view')) && { title: 'Kategori Pengajuan', href: '/submission-categories', icon: Tags },
        (can('submission-masters.view') || can('submission-types.view')) && { title: 'Jenis Pengajuan', href: '/submission-types', icon: ListChecks },
