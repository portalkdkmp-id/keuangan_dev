...
export default function Index({
    ...
    const pending = [
        ...directDisbursements.map((item: any) => ({
            ...item,
            sourceType: 'disbursements',
        })),
    ...
    const proofUrl = (item: any, attachment: any) =>
        item.sourceType === 'disbursements'
        ...
        <div className="space-y-6 p-4">
            ...
            <div>
                ...
                <p className="text-sm text-muted-foreground">
                    Konfirmasi hanya setelah dana benar-benar masuk ke rekening
                    tujuan.
                </p>
            </div>
            <div className="grid gap-3 md:grid-cols-2">
                {pending.length ? (
                    pending.map((item: any) => (
                        ...
                        >
                            ...
                            <div className="text-sm text-muted-foreground">
                                Tujuan:{' '}
                                {item.destination_bank_snapshot ??
                                    item.destination_bank_name_snapshot}{' '}
                                · Referensi: {item.transaction_reference ?? '-'}
                            </div>
                            <div className="text-sm">
                                Bukti:{' '}
                    ...
                    <div className="rounded-md border border-dashed p-8 text-center text-muted-foreground md:col-span-2">
                        Tidak ada dana yang menunggu konfirmasi.
                    </div>
                )}
            </div>
            <div className="overflow-x-auto rounded-md border">
                <Table>
                    ...
                    <TableBody>
                        {confirmations.data.map((item: any) => (
            ...
            >
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>Konfirmasi Dana Diterima</DialogTitle>
                    </DialogHeader>
                    <Label>Tanggal dan waktu diterima</Label>
                    <Input
                        type="datetime-local"
                    ...
                    <Textarea
                        required
                        placeholder="Tuliskan catatan penerimaan dana"
