...
export default function SubmissionsRevision({
    submission,
    cooperatives,
    requestCategories,
    requestTypes,
    ...
    return (
        <div className="space-y-4 p-4">
            <Head title={`Revisi ${submission.submission_number}`} />
            ...
            <SubmissionForm
                ...
                onSubmit={() =>
                    form.put(`/submissions/${submission.id}/revision`)
                }
            ...
            <form
                onSubmit={(e) => {
                    e.preventDefault();
                    responseForm.post(`/submissions/${submission.id}/resubmit`);
                }}
            ...
            >
                ...
                <textarea
                    ...
                    onChange={(e) =>
                        responseForm.setData('message', e.target.value)
                    }
                />
                <div className="flex gap-2">
                    <Button disabled={responseForm.processing}>
                        Kirim Ulang
                    </Button>
                    <Button
                        type="button"
                        variant="outline"
                        onClick={() =>
                            router.visit(`/submissions/${submission.id}`)
                        }
                    >
                        Lihat Detail
                    </Button>
